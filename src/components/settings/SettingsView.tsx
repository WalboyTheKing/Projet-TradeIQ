  ...
  const plans = [
    {
      ...
      name: 'Free Tier',
      priceMonthly: `$${PRICING_PLANS.free.pricing.monthly.amountUsdt}`,
      priceYearly: `$${PRICING_PLANS.free.pricing.yearly.amountUsdt}`,
      description: 'Foundational analytical tooling for exploring traders',
      features: PRICING_PLANS.free.features,
      current: userProfile.role !== 'admin' && currentPlanId === 'free',
    },
    {
      id: 'pro' as SubscriptionPlan,
      name: 'Pro Tier',
      priceMonthly: `$${PRICING_PLANS.pro.pricing.monthly.amountUsdt} / mo`,
      priceYearly: `$${PRICING_PLANS.pro.pricing.yearly.amountUsdt} / yr (Save 17%)`,
      description: 'Advanced quantitative metrics, risk modeling & multimodal AI',
      features: PRICING_PLANS.pro.features,
      current: userProfile.role !== 'admin' && currentPlanId === 'pro',
      popular: true,
    },
    {
      id: 'premium' as SubscriptionPlan,
      name: 'Premium Tier',
      priceMonthly: `$${PRICING_PLANS.premium.pricing.monthly.amountUsdt} / mo`,
      priceYearly: `$${PRICING_PLANS.premium.pricing.yearly.amountUsdt} / yr (Save 17%)`,
      description: 'Maximum AI capacity, deep behavioral audits & priority processing',
      features: PRICING_PLANS.premium.features,
      current: userProfile.role !== 'admin' && currentPlanId === 'premium',
    },
  ];
